...
| 3 | Send cold emails via Instantly | `cold_email_outreach.md` |
| 4 | Handle responses + close | `icp_and_sales_angle.md` (objection handling) |
...
- [ ] Scrape first batch of leads (Scrap.io + Apify)
- [ ] Verify emails (ZeroBounce / NeverBounce / MillionVerifier)
- [ ] Segment leads by type (see `icp_and_sales_angle.md` segments)
