# Directive: Ideal Client Profile & Sales Angle
...
- One place to see all their clients and their progress
- Automated check-in reminders so nobody falls through the cracks
- Look professional and premium to justify their $200/month coaching fee
- Scale from 20 to 40+ clients without doubling their hours
...
- A generic app that kind of fits
- Something they have to set up themselves
...
**"I already use Trainerize/TrueCoach"**
...
→ "Typically [X days/weeks] from our first call to a working dashboard." (Confirm timeline with Kamil)

---

## Segmentation for Outreach

When building your lead list, tag each coach with a segment so you can personalize emails:

| Segment | Description | Pain angle in email |
|---------|-------------|---------------------|
| **Scaling coach** | 20-40 clients, posting about being busy/overwhelmed | "Scale past 30 clients without more hours" |
| **Premium coach** | Charges $200+/mo, polished brand | "Match the quality of your coaching with a professional dashboard" |
| **Tool-frustrated** | Currently uses Trainerize/TrueCoach, complains about it | "Stop paying $150/mo for features you don't use" |
| **Spreadsheet coach** | Manages everything in Google Sheets/Excel | "Your clients deserve better than a spreadsheet" |
| **New-ish coach** | 10-20 clients, growing fast | "Set up the right systems now before it gets chaotic" |
