...
case "${1:-both}" in
  ...
  all)            deploy_dashboard; deploy_landing; deploy_igpipeline; deploy_client_portal ;;
  *)              echo "Usage: ./shared/deploy.sh [dashboard|landing|client-portal|igpipeline|both|all]" ;;
esac
