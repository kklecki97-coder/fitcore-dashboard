...
export const myMessages: Message[] = [
  { id: 'msg1', clientId: 'c1', clientName: 'Marcus Chen', clientAvatar: '', text: 'Hey Coach, just hit 92.5kg on bench today! 🔥', timestamp: '2026-02-21T14:30:00', isRead: true, isFromCoach: false},
  ...
  { id: 'msg9', clientId: 'c1', clientName: 'Marcus Chen', clientAvatar: '', text: 'Feeling good! Sleep has been much better since I cut the late-night screen time. Will submit check-in Sunday evening.', timestamp: '2026-02-19T19:22:00', isRead: true, isFromCoach: false},
  { id: 'msg10', clientId: 'c1', clientName: 'Marcus Chen', clientAvatar: '', text: 'That\'s great to hear. The sleep changes are the game changer honestly. Talk Sunday 🙌', timestamp: '2026-02-19T19:30:00', isRead: true, isFromCoach: true},
  { id: 'msg11', clientId: 'c1', clientName: 'Marcus Chen', clientAvatar: '', text: 'Coach, I\'m feeling a bit of shoulder discomfort on overhead press. Nothing sharp, just tightness.', timestamp: '2026-02-17T16:45:00', isRead: true, isFromCoach: false},
  { id: 'msg12', clientId: 'c1', clientName: 'Marcus Chen', clientAvatar: '', text: 'Thanks for flagging that. Let\'s swap OHP for landmine press this week and see if it feels better. Do some extra band pull-aparts in your warm-up too.', timestamp: '2026-02-17T17:15:00', isRead: true, isFromCoach: true},
];
