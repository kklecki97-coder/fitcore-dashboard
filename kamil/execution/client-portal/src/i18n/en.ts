export const en = {
  ...
  progress: {
    ...
    noDataYet: 'Start training and set goals to track your overall progress',
    strength: 'Strength',
    bodyFat: 'Body Fat',
    height: 'Height',
    progressPhotos: 'Progress Photos',
    ...
    current: 'Current',
    change: 'Change',
    noMeasurementsYet: 'Measurements will appear after check-ins',
  },
  ...
  nutrition: {
    ...
    noPlanSub: 'Your coach will assign a nutrition plan when ready.',
    ...
    completed: 'Completed',
    paused: 'Paused',
    planType: { strict: 'Strict Plan', flexible: 'Flexible Plan', guidelines: 'Guidelines' } as Record<string, string>,
  },
  ...
  onboarding: {
    ...
    targetsTitle: 'Set Your Targets',
    targetsSub: 'Optional — set concrete numbers to track your progress.',
    targetWeight: 'Target Weight',
    targetBodyFat: 'Target Body Fat',
    targetBenchPress: 'Target Bench Press',
    targetSquat: 'Target Squat',
    targetDeadlift: 'Target Deadlift',
    targetsSkipHint: 'You can skip this — your coach can set targets later.',
