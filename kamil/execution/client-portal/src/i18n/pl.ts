...
export const pl: Translations = {
  ...
  program: {
    ...
    weeks: 'tygodni',
    howToDoThis: 'Jak wykonać ćwiczenie',
    instructions: 'Instrukcje',
    tips: 'Wskazówki',
    musclesWorked: 'Mięśnie',
    primary: 'Główne',
  ...
  checkIn: {
    ...
    bodyMeasurements: 'Obwody Ciała',
    waistCm: 'Talia (cm)',
    hipsCm: 'Biodra (cm)',
    chestCm: 'Klatka piersiowa (cm)',
    bicepCm: 'Biceps (cm)',
    thighCm: 'Udo (cm)',
  ...
  progress: {
    ...
    goalsComponent: 'Cele',
    frequencyComponent: 'Frekwencja',
    noDataYet: 'Zacznij trenować i ustaw cele, aby śledzić swój postęp',
    strength: 'Siła',
    ...
    current: 'Teraz',
    change: 'Zmiana',
    noMeasurementsYet: 'Pomiary pojawią się po check-inach',
  },
  ...
  nutrition: {
    title: 'Twój plan żywieniowy',
    noPlan: 'Brak przypisanego planu',
    noPlanSub: 'Twój trener przypisze Ci plan żywieniowy, gdy będzie gotowy.',
    ...
    history: 'Poprzednie plany',
    active: 'Aktywny',
    completed: 'Zakończony',
    paused: 'Wstrzymany',
    planType: { strict: 'Ścisły plan', flexible: 'Elastyczny plan', guidelines: 'Wytyczne' } as Record<string, string>,
  },
  ...
  onboarding: {
    ...
    welcomeSub: (coachName: string) => `Twój trener ${coachName} jest gotowy pomóc Ci osiągnąć cele. Uzupełnijmy Twój profil.`,
    getStarted: 'Zaczynajmy',
    statsTitle: 'Twoje Dane',
    statsSub: 'To pomoże trenerowi śledzić Twoje postępy od pierwszego dnia.',
    heightCm: 'Wzrost (cm)',
    weightKg: 'Waga (kg)',
    bodyFatPercent: 'Tkanka tłuszczowa (%)',
    bodyFatPlaceholder: 'np. 15',
    optional: 'Opcjonalne — pomiń jeśli nie wiesz',
    next: 'Dalej',
    prsTitle: 'Twoja Wyjściowa Siła',
    prsSub: 'Czas się pochwalić! Jakie są Twoje aktualne rekordy życiowe?',
    benchPress: 'Wyciskanie',
    squat: 'Przysiad',
    deadlift: 'Martwy Ciąg',
    prsSkipHint: 'Nie wiesz? Luz — możesz to uzupełnić później',
    skip: 'Pomiń',
    ...
    targetsTitle: 'Ustaw Swoje Cele',
    targetsSub: 'Opcjonalne — ustaw konkretne liczby żeby śledzić postępy.',
    targetWeight: 'Docelowa Waga',
    targetBodyFat: 'Docelowa Tkanka Tłuszczowa',
    targetBenchPress: 'Cel Wyciskanie',
    targetSquat: 'Cel Przysiad',
    targetDeadlift: 'Cel Martwy Ciąg',
    targetsSkipHint: 'Możesz pominąć — trener ustawi cele później.',
    summaryTitle: 'Wszystko Gotowe!',
    summarySub: (name: string) => `Oto Twój profil startowy, ${name}. Do roboty!`,
    coachedBy: (coachName: string) => `Trener: ${coachName}`,
    finish: 'Zaczynamy!',
    saving: 'Zapisywanie...',
  ...
  habits: {
    ...
    completed: (n: number, total: number) => `${n}/${total} zrealizowanych`,
    allDone: 'Wszystko na dziś zrobione!',
    logHabit: 'Zapisz Nawyk',
    streak: 'Seria',
    streakDays: (n: number) => `${n} ${n === 1 ? 'dzień' : 'dni'}`,
    noHabits: 'Brak przypisanych nawyków. Twój trener je ustawi.',
    habitLogged: 'Nawyk zapisany!',
    habitHistory: 'Historia Nawyków',
    adherence: 'Realizacja',
    last7Days: 'Ostatnie 7 dni',
    last30Days: 'Ostatnie 30 dni',
    title: 'Moje Nawyki',
    subtitle: 'Śledź swoje codzienne nawyki i serie',
    ...
    milestoneWeek: 'Seria 7 dni! Tak trzymaj!',
    milestoneMonth: 'Seria 30 dni! Niesamowite!',
    tapToLog: 'Kliknij aby zapisać',
    done: 'Gotowe',
  },
