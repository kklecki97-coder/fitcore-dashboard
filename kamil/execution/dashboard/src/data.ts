import type { Client, Message, RevenueData, WorkoutLog, WorkoutProgram, Invoice, CheckIn, Habit, HabitAssignment, HabitLog } from './types';

// Re-export from utils/formatting so existing imports continue to work
export { getInitials, getAvatarColor } from './utils/formatting';
...
export const checkIns: CheckIn[] = [
  ...
  { id: 'ci-01', clientId: 'c1', clientName: 'Marcus Chen', date: '2026-02-22', status: 'scheduled', weight: null, bodyFat: null, mood: null, energy: null, stress: null, sleepHours: null, steps: null, nutritionScore: null, notes: '', wins: '', challenges: '', coachFeedback: '', reviewStatus: 'pending', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-02', clientId: 'c1', clientName: 'Marcus Chen', date: '2026-02-15', status: 'completed', weight: 86, bodyFat: 17, mood: 4, energy: 8, stress: 3, sleepHours: 7.5, steps: 10200, nutritionScore: 8, notes: 'Feeling strong. Bench PR this week. Sleep could be better on weekends.', wins: 'Bench PR 102.5kg x2, Hit all 4 sessions, Protein target every day', challenges: 'Weekend sleep was rough - stayed up late Saturday', coachFeedback: 'Great progress Marcus! Keep the momentum. Add 2.5kg to bench next week.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-03', clientId: 'c1', clientName: 'Marcus Chen', date: '2026-02-08', status: 'completed', weight: 86.5, bodyFat: 17.2, mood: 3, energy: 6, stress: 5, sleepHours: 7, steps: 9500, nutritionScore: 7, notes: 'Missed one session due to work. Otherwise solid week.', wins: 'Squat felt smooth at 130kg, Meal prepped Sunday, Walked 10k steps 5/7 days', challenges: 'Work deadline killed my Thursday session, Stress eating on Wednesday', coachFeedback: 'No worries about the missed session. Nutrition was on point - keep it up.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-04', clientId: 'c1', clientName: 'Marcus Chen', date: '2026-02-01', status: 'completed', weight: 87, bodyFat: 17.5, mood: 4, energy: 8, stress: 2, sleepHours: 8, steps: 11000, nutritionScore: 9, notes: 'Best week so far. Hit all sessions and nailed macros.', wins: 'All 4 sessions completed, Macros within 5% every day, New deadlift rep PR', challenges: 'None this week - felt great all around', coachFeedback: 'Incredible consistency! This is exactly how we build results.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-04b', clientId: 'c1', clientName: 'Marcus Chen', date: '2026-01-25', status: 'completed', weight: 87.5, bodyFat: 17.8, mood: 3, energy: 5, stress: 6, sleepHours: 6.5, steps: 7500, nutritionScore: 6, notes: 'Rough week. Work stress got to me. Still made it to 3 sessions.', wins: 'Showed up despite not feeling it, Kept protein high', challenges: 'Only 3/4 sessions, Late nights at work, Cravings on Thursday', coachFeedback: 'Showing up when you don\'t feel like it IS the win. Let\'s aim for 4 sessions next week.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-04c', clientId: 'c1', clientName: 'Marcus Chen', date: '2026-01-18', status: 'completed', weight: 88, bodyFat: 18, mood: 4, energy: 7, stress: 3, sleepHours: 7.5, steps: 10500, nutritionScore: 8, notes: 'Back on track. Energy was great midweek.', wins: '4/4 sessions done, Brought lunch to work every day, Hit a squat PR', challenges: 'Sunday was a rest day I didn\'t plan - felt lazy', coachFeedback: 'Great bounce back! Unplanned rest days happen. Your body needed it.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },

  // ── Sarah Williams - rehabbing knee, steady progress ──
  { id: 'ci-05', clientId: 'c2', clientName: 'Sarah Williams', date: '2026-02-23', status: 'scheduled', weight: null, bodyFat: null, mood: null, energy: null, stress: null, sleepHours: null, steps: null, nutritionScore: null, notes: '', wins: '', challenges: '', coachFeedback: '', reviewStatus: 'pending', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-06', clientId: 'c2', clientName: 'Sarah Williams', date: '2026-02-16', status: 'completed', weight: 66.5, bodyFat: 24, mood: 4, energy: 7, stress: 3, sleepHours: 7, steps: 8500, nutritionScore: 7, notes: 'Knee feels great! Did deeper squats this week without pain.', wins: 'Pain-free squats for the first time, Completed all 3 sessions, Down 0.5kg', challenges: 'Still nervous about going heavy on legs', coachFeedback: 'Excellent news about the knee. Let\'s progress to parallel squats next week.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-07', clientId: 'c2', clientName: 'Sarah Williams', date: '2026-02-09', status: 'completed', weight: 67, bodyFat: 24.2, mood: 3, energy: 5, stress: 5, sleepHours: 6.5, steps: 6800, nutritionScore: 6, notes: 'Skipped one session - felt tired. Knee was a bit stiff on Tuesday.', wins: 'Completed 2/3 sessions, Foam rolled every morning', challenges: 'Knee stiffness on Tuesday, Low energy all week, Ate out 3 times', coachFeedback: 'Rest when you need to. Try 10 min foam rolling before leg days for the stiffness.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-07b', clientId: 'c2', clientName: 'Sarah Williams', date: '2026-02-02', status: 'completed', weight: 67.5, bodyFat: 24.5, mood: 3, energy: 6, stress: 4, sleepHours: 7, steps: 6200, nutritionScore: 5, notes: 'Struggled with nutrition this week. Knee felt okay though.', wins: 'Knee improving steadily, Hit a deadlift PR 82.5kg', challenges: 'Nutrition fell off - too many meals out, Only 2/3 sessions', coachFeedback: 'Focus on meal prep this weekend. Even just 3-4 meals ready to go makes a huge difference.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-07c', clientId: 'c2', clientName: 'Sarah Williams', date: '2026-01-26', status: 'completed', weight: 68, bodyFat: 25, mood: 2, energy: 4, stress: 7, sleepHours: 5.5, steps: 4500, nutritionScore: 4, notes: 'Terrible week. Knee flared up on Monday and I panicked. Barely trained.', wins: 'Still showed up twice', challenges: 'Knee pain scare, Work was insane, Only slept 5-6 hours most nights', coachFeedback: 'I understand the frustration. The flare-up was likely from overuse, not damage. Let\'s dial back leg volume next week.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },

  // ── Jake Morrison - elite, comp prep ──
  { id: 'ci-08', clientId: 'c3', clientName: 'Jake Morrison', date: '2026-02-21', status: 'completed', weight: 85.2, bodyFat: 11.8, mood: 5, energy: 9, stress: 2, sleepHours: 9, steps: 12000, nutritionScore: 10, notes: 'Peak week starts now. Everything is dialed in. Best I\'ve ever felt going into a comp.', wins: 'All 6 sessions crushed, Perfect nutrition all week, 9hr sleep average, New squat PR 167.5kg', challenges: 'None - everything clicked this week', coachFeedback: '', reviewStatus: 'pending', flagReason: '', photos: [{ url: '/mock/jake-front-w8.jpg', label: 'front' }, { url: '/mock/jake-side-w8.jpg', label: 'side' }, { url: '/mock/jake-back-w8.jpg', label: 'back' }], followUpNotes: [] },
  { id: 'ci-09', clientId: 'c3', clientName: 'Jake Morrison', date: '2026-02-14', status: 'completed', weight: 85, bodyFat: 12, mood: 5, energy: 8, stress: 2, sleepHours: 8.5, steps: 11500, nutritionScore: 9, notes: 'Competition prep going perfectly. All lifts trending up. Feeling dialed in.', wins: '6/6 sessions, Squat 165kg x2, Bench 117.5kg smooth, Weight on target', challenges: 'Slight hip tightness on Wednesday - foam rolled it out', coachFeedback: 'You\'re peaking at the right time. Start reducing volume next week for peak week.', reviewStatus: 'reviewed', flagReason: '', photos: [{ url: '/mock/jake-front-w7.jpg', label: 'front' }, { url: '/mock/jake-side-w7.jpg', label: 'side' }], followUpNotes: [{ text: 'Sent updated peak week program via email. Jake confirmed he received it.', date: '2026-02-15' }] },
  { id: 'ci-10', clientId: 'c3', clientName: 'Jake Morrison', date: '2026-02-07', status: 'completed', weight: 84.5, bodyFat: 12.2, mood: 4, energy: 7, stress: 3, sleepHours: 8, steps: 10800, nutritionScore: 9, notes: 'Deadlift felt heavy. Might need an extra rest day.', wins: '5/6 sessions, Bench PR attempt went well, Nutrition dialed', challenges: 'Deadlift 195kg felt like RPE 10, Accumulated fatigue', coachFeedback: 'Fatigue is expected at this stage. Take Friday completely off, we\'ll push hard Monday.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-10b', clientId: 'c3', clientName: 'Jake Morrison', date: '2026-01-31', status: 'completed', weight: 84.2, bodyFat: 12.5, mood: 4, energy: 8, stress: 2, sleepHours: 8.5, steps: 12500, nutritionScore: 9, notes: 'Great training week. Volume is feeling manageable again.', wins: '6/6 sessions, Deadlift 190kg felt easy, Sleep was excellent', challenges: 'Slight quad soreness from heavy squats', coachFeedback: 'Volume adaptation is kicking in. Great sign 4 weeks out.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-10c', clientId: 'c3', clientName: 'Jake Morrison', date: '2026-01-24', status: 'completed', weight: 84, bodyFat: 12.8, mood: 3, energy: 6, stress: 4, sleepHours: 7.5, steps: 9800, nutritionScore: 8, notes: 'Felt a bit run down mid-week. Skipped accessories on Thursday.', wins: '5/6 sessions, Bench still progressing, Weight holding steady', challenges: 'Fatigue accumulation, Slight headache Thursday', coachFeedback: 'Normal fatigue for this training phase. Keep calories up - don\'t cut now.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },

  // ── David Park - shift worker, struggling with sleep ──
  { id: 'ci-11', clientId: 'c5', clientName: 'David Park', date: '2026-02-25', status: 'scheduled', weight: null, bodyFat: null, mood: null, energy: null, stress: null, sleepHours: null, steps: null, nutritionScore: null, notes: '', wins: '', challenges: '', coachFeedback: '', reviewStatus: 'pending', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-12', clientId: 'c5', clientName: 'David Park', date: '2026-02-18', status: 'completed', weight: 83, bodyFat: 17, mood: 3, energy: 4, stress: 7, sleepHours: 5.5, steps: 5500, nutritionScore: 5, notes: 'Tough week with shift changes. Sleep was terrible. Managed 3 sessions.', wins: 'Made it to gym 3 times despite shifts, Kept water intake up', challenges: 'Sleep averaged 5.5 hours, Ate fast food twice, Night shifts killed motivation', coachFeedback: 'Sleep is your bottleneck right now. Try melatonin 30min before bed on night shifts.', reviewStatus: 'flagged', flagReason: 'Sleep declining 3 weeks - needs schedule adjustment', photos: [], followUpNotes: [{ text: 'Texted David about trying melatonin. Will check back Wednesday.', date: '2026-02-19' }] },
  { id: 'ci-13', clientId: 'c5', clientName: 'David Park', date: '2026-02-11', status: 'missed', weight: null, bodyFat: null, mood: null, energy: null, stress: null, sleepHours: null, steps: null, nutritionScore: null, notes: '', wins: '', challenges: '', coachFeedback: 'Missed check-in - followed up via email. Double shift week.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-13b', clientId: 'c5', clientName: 'David Park', date: '2026-02-04', status: 'completed', weight: 83.5, bodyFat: 17.2, mood: 3, energy: 5, stress: 6, sleepHours: 6, steps: 6500, nutritionScore: 6, notes: 'Better than last week. Got 3 solid sessions in. Sleep still bad.', wins: '3/4 sessions done, Found a meal prep service that delivers', challenges: 'Night shifts continue, Sleep under 6hr on work nights', coachFeedback: 'Meal prep service is a smart move. Let\'s try shifting your workout window to accommodate shifts.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-13c', clientId: 'c5', clientName: 'David Park', date: '2026-01-28', status: 'completed', weight: 84, bodyFat: 17.5, mood: 2, energy: 3, stress: 8, sleepHours: 5, steps: 3800, nutritionScore: 4, notes: 'Worst week so far. Only made it twice. Shift schedule is killing me.', wins: 'Didn\'t quit, Still tracked what I ate', challenges: '2/4 sessions only, 5hr sleep average, Stress through the roof', coachFeedback: 'Two sessions is still better than zero. We need to talk about adjusting your schedule - let\'s book a quick call.', reviewStatus: 'flagged', flagReason: 'Adherence dropped to 50% - needs coaching call', photos: [], followUpNotes: [] },

  // ── Tom Bradley - weight loss journey, motivated ──
  { id: 'ci-14', clientId: 'c7', clientName: 'Tom Bradley', date: '2026-02-22', status: 'scheduled', weight: null, bodyFat: null, mood: null, energy: null, stress: null, sleepHours: null, steps: null, nutritionScore: null, notes: '', wins: '', challenges: '', coachFeedback: '', reviewStatus: 'pending', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-15', clientId: 'c7', clientName: 'Tom Bradley', date: '2026-02-15', status: 'completed', weight: 96, bodyFat: 23.5, mood: 5, energy: 8, stress: 2, sleepHours: 7, steps: 11000, nutritionScore: 8, notes: 'Under 96kg for the first time! Cardio is getting easier too.', wins: 'Sub-96kg milestone!, 4/4 sessions, Ran 5K without stopping for the first time, Cooked every meal this week', challenges: 'Sunday dinner out was hard to track macros', coachFeedback: 'Massive milestone Tom! 9kg down is no joke. Let\'s target 93 by end of March.', reviewStatus: 'reviewed', flagReason: '', photos: [{ url: '/mock/tom-front-w6.jpg', label: 'front' }, { url: '/mock/tom-side-w6.jpg', label: 'side' }], followUpNotes: [{ text: 'Called Tom to congratulate on sub-96 milestone. Very motivated - set new target 93kg by March.', date: '2026-02-16' }] },
  { id: 'ci-16', clientId: 'c7', clientName: 'Tom Bradley', date: '2026-02-08', status: 'completed', weight: 96.5, bodyFat: 23.8, mood: 4, energy: 7, stress: 3, sleepHours: 7.5, steps: 9000, nutritionScore: 7, notes: 'Missed one cardio session but kept nutrition clean.', wins: '3/4 sessions completed, Nutrition was solid all week, Lost 0.5kg', challenges: 'Skipped Saturday cardio - was at a friend\'s birthday', coachFeedback: 'Nutrition consistency matters more than one missed cardio. You\'re doing great.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-16b', clientId: 'c7', clientName: 'Tom Bradley', date: '2026-02-01', status: 'completed', weight: 97, bodyFat: 24, mood: 4, energy: 7, stress: 3, sleepHours: 7, steps: 10000, nutritionScore: 7, notes: 'Solid week. Starting to actually enjoy cardio which is wild.', wins: '4/4 sessions, First time enjoying a run, Weight still trending down', challenges: 'Craved pizza hard on Wednesday - had a small portion instead of none', coachFeedback: 'Having a small portion IS the win. That\'s sustainable. Keep doing that.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-16c', clientId: 'c7', clientName: 'Tom Bradley', date: '2026-01-25', status: 'completed', weight: 97.5, bodyFat: 24.3, mood: 3, energy: 6, stress: 4, sleepHours: 6.5, steps: 7800, nutritionScore: 6, notes: 'Good but not great. Felt tired midweek.', wins: '3/4 sessions, Kept tracking even when off plan', challenges: 'Midweek fatigue, Ate out twice, Sleep was broken 2 nights', coachFeedback: 'Tracking when off-plan shows maturity. That data helps us adjust. Prioritize sleep this week.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },

  // ── Aisha Patel - newer client, building habits ──
  { id: 'ci-17', clientId: 'c8', clientName: 'Aisha Patel', date: '2026-02-26', status: 'scheduled', weight: null, bodyFat: null, mood: null, energy: null, stress: null, sleepHours: null, steps: null, nutritionScore: null, notes: '', wins: '', challenges: '', coachFeedback: '', reviewStatus: 'pending', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-18', clientId: 'c8', clientName: 'Aisha Patel', date: '2026-02-19', status: 'completed', weight: 57, bodyFat: 24.5, mood: 4, energy: 7, stress: 3, sleepHours: 7, steps: 8200, nutritionScore: 7, notes: 'Really enjoying the new glute focus! Posture feels better at work.', wins: 'Posture improvement at desk, Completed all 3 sessions, Tried hip thrusts for the first time', challenges: 'Still figuring out pre-workout nutrition', coachFeedback: 'That\'s the posture work paying off. Adding hip thrusts next week.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-18b', clientId: 'c8', clientName: 'Aisha Patel', date: '2026-02-12', status: 'completed', weight: 57.5, bodyFat: 25, mood: 3, energy: 6, stress: 4, sleepHours: 6.5, steps: 6000, nutritionScore: 6, notes: 'Okay week. Work got busy and I missed Friday.', wins: '2/3 sessions, Started eating more protein', challenges: 'Missed Friday session, Didn\'t meal prep', coachFeedback: 'Protein increase is great! Try prepping just 3 meals for the busy days - doesn\'t need to be all week.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-18c', clientId: 'c8', clientName: 'Aisha Patel', date: '2026-02-05', status: 'completed', weight: 57.5, bodyFat: 25, mood: 4, energy: 7, stress: 3, sleepHours: 7, steps: 8000, nutritionScore: 6, notes: 'Felt good this week. Getting into a routine.', wins: '3/3 sessions done!, Morning routine is becoming a habit', challenges: 'Nutrition still inconsistent on weekends', coachFeedback: 'Consistency breeds results. Great to see the routine forming!', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },

  // ── Emma Rodriguez - beginner, high enthusiasm ──
  { id: 'ci-19', clientId: 'c4', clientName: 'Emma Rodriguez', date: '2026-02-24', status: 'scheduled', weight: null, bodyFat: null, mood: null, energy: null, stress: null, sleepHours: null, steps: null, nutritionScore: null, notes: '', wins: '', challenges: '', coachFeedback: '', reviewStatus: 'pending', flagReason: '', photos: [], followUpNotes: [] },
  { id: 'ci-20', clientId: 'c4', clientName: 'Emma Rodriguez', date: '2026-02-17', status: 'completed', weight: 74.5, bodyFat: 29.5, mood: 4, energy: 7, stress: 3, sleepHours: 7, steps: 7000, nutritionScore: 5, notes: 'Had my first workout and loved it! Still figuring out the gym routine.', wins: 'First week in the gym!, Tried squats for the first time, Signed up for MyFitnessPal', challenges: 'Felt intimidated at the gym, Not sure how to track macros yet, Missed Wednesday', coachFeedback: 'Amazing start Emma! Don\'t worry about perfection yet - consistency is key. We\'ll dial in nutrition next.', reviewStatus: 'reviewed', flagReason: '', photos: [], followUpNotes: [] },
];
...
export const presetHabits: Habit[] = [
  ...
  { id: 'h-meditation', coachId: null, name: 'Meditation', type: 'number', defaultTarget: 10, unit: 'min', icon: 'Brain', isPreset: true, isActive: true, createdAt: '2026-01-01' },
  { id: 'h-stretching', coachId: null, name: 'Stretching', type: 'checkbox', defaultTarget: null, unit: null, icon: 'StretchHorizontal', isPreset: true, isActive: true, createdAt: '2026-01-01' },
  { id: 'h-protein', coachId: null, name: 'Protein Intake', type: 'number', defaultTarget: 150, unit: 'g', icon: 'Beef', isPreset: true, isActive: true, createdAt: '2026-01-01' },
];

// ── Mock Habit Assignments (for demo clients) ──
export const habitAssignments: HabitAssignment[] = [
  // Marcus Chen (c1) — water, sleep, creatine, omega3, vitD, steps
  ...
  // Sarah Williams (c2) — water, sleep, stretching
  { id: 'ha-5', coachId: 'coach1', clientId: 'c2', habitId: 'h-water', targetValue: 2.5, startDate: '2026-02-10', endDate: null, isActive: true, createdAt: '2026-02-10' },
  { id: 'ha-6', coachId: 'coach1', clientId: 'c2', habitId: 'h-sleep', targetValue: 8, startDate: '2026-02-10', endDate: null, isActive: true, createdAt: '2026-02-10' },
  { id: 'ha-7', coachId: 'coach1', clientId: 'c2', habitId: 'h-stretching', targetValue: null, startDate: '2026-02-10', endDate: null, isActive: true, createdAt: '2026-02-10' },
  // Jake Morrison (c3) — water, sleep, creatine, omega3, vitD, magnesium, whey, protein, steps
  { id: 'ha-8', coachId: 'coach1', clientId: 'c3', habitId: 'h-water', targetValue: 4, startDate: '2026-01-15', endDate: null, isActive: true, createdAt: '2026-01-15' },
  { id: 'ha-9', coachId: 'coach1', clientId: 'c3', habitId: 'h-sleep', targetValue: 8, startDate: '2026-01-15', endDate: null, isActive: true, createdAt: '2026-01-15' },
  { id: 'ha-10', coachId: 'coach1', clientId: 'c3', habitId: 'h-creatine', targetValue: null, startDate: '2026-01-15', endDate: null, isActive: true, createdAt: '2026-01-15' },
  { id: 'ha-10b', coachId: 'coach1', clientId: 'c3', habitId: 'h-omega3', targetValue: null, startDate: '2026-01-15', endDate: null, isActive: true, createdAt: '2026-01-15' },
  { id: 'ha-10c', coachId: 'coach1', clientId: 'c3', habitId: 'h-vitamind', targetValue: null, startDate: '2026-01-15', endDate: null, isActive: true, createdAt: '2026-01-15' },
  { id: 'ha-10d', coachId: 'coach1', clientId: 'c3', habitId: 'h-magnesium', targetValue: null, startDate: '2026-01-15', endDate: null, isActive: true, createdAt: '2026-01-15' },
  { id: 'ha-10e', coachId: 'coach1', clientId: 'c3', habitId: 'h-whey', targetValue: null, startDate: '2026-01-15', endDate: null, isActive: true, createdAt: '2026-01-15' },
  { id: 'ha-11', coachId: 'coach1', clientId: 'c3', habitId: 'h-protein', targetValue: 180, startDate: '2026-01-15', endDate: null, isActive: true, createdAt: '2026-01-15' },
  { id: 'ha-12', coachId: 'coach1', clientId: 'c3', habitId: 'h-steps', targetValue: 12000, startDate: '2026-01-15', endDate: null, isActive: true, createdAt: '2026-01-15' },
];

// ── Mock Habit Logs (last 14 days for demo clients) ──
function generateHabitLogs(): HabitLog[] {
  const logs: HabitLog[] = [];
  const today = new Date('2026-03-21');
  let logId = 1;

  const assignments: { assignmentId: string; clientId: string; type: 'checkbox' | 'number'; target: number | null; adherenceRate: number }[] = [
    // Marcus — high adherence
    { assignmentId: 'ha-1', clientId: 'c1', type: 'number', target: 3, adherenceRate: 0.85 },
    { assignmentId: 'ha-2', clientId: 'c1', type: 'number', target: 7.5, adherenceRate: 0.7 },
    { assignmentId: 'ha-3', clientId: 'c1', type: 'checkbox', target: null, adherenceRate: 0.9 },
    { assignmentId: 'ha-3b', clientId: 'c1', type: 'checkbox', target: null, adherenceRate: 0.85 },
    { assignmentId: 'ha-3c', clientId: 'c1', type: 'checkbox', target: null, adherenceRate: 0.8 },
    { assignmentId: 'ha-4', clientId: 'c1', type: 'number', target: 10000, adherenceRate: 0.75 },
    // Sarah — medium adherence
    { assignmentId: 'ha-5', clientId: 'c2', type: 'number', target: 2.5, adherenceRate: 0.6 },
    { assignmentId: 'ha-6', clientId: 'c2', type: 'number', target: 8, adherenceRate: 0.5 },
    { assignmentId: 'ha-7', clientId: 'c2', type: 'checkbox', target: null, adherenceRate: 0.65 },
    // Jake — very high adherence
    { assignmentId: 'ha-8', clientId: 'c3', type: 'number', target: 4, adherenceRate: 0.95 },
    { assignmentId: 'ha-9', clientId: 'c3', type: 'number', target: 8, adherenceRate: 0.9 },
    { assignmentId: 'ha-10', clientId: 'c3', type: 'checkbox', target: null, adherenceRate: 0.95 },
    { assignmentId: 'ha-10b', clientId: 'c3', type: 'checkbox', target: null, adherenceRate: 0.9 },
    { assignmentId: 'ha-10c', clientId: 'c3', type: 'checkbox', target: null, adherenceRate: 0.88 },
    { assignmentId: 'ha-10d', clientId: 'c3', type: 'checkbox', target: null, adherenceRate: 0.85 },
    { assignmentId: 'ha-10e', clientId: 'c3', type: 'checkbox', target: null, adherenceRate: 0.92 },
    { assignmentId: 'ha-11', clientId: 'c3', type: 'number', target: 180, adherenceRate: 0.85 },
    { assignmentId: 'ha-12', clientId: 'c3', type: 'number', target: 12000, adherenceRate: 0.8 },
  ];
  ...
  for (let dayOffset = 0; dayOffset < 14; dayOffset++) {
    ...
    for (const a of assignments) {
      const completed = Math.random() < a.adherenceRate;
      let value: number | null = null;
      if (a.type === 'checkbox') {
        value = completed ? 1 : 0;
      } else if (a.target !== null) {
        // Generate a realistic value around the target
...
export const habitLogs: HabitLog[] = generateHabitLogs();
