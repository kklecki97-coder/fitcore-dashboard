...
export const checkIns: CheckIn[] = [
  ...
  { id: 'ci-14', clientId: 'c7', clientName: 'Tom Bradley', date: '2026-02-22', status: 'scheduled', weight: null, bodyFat: null, mood: null, energy: null, stress: null, sleepHours: null, adherence: null, nutritionScore: null, notes: '', wins: '', challenges: '', coachFeedback: '', reviewStatus: 'pending', flagReason: '' },
  { id: 'ci-15', clientId: 'c7', clientName: 'Tom Bradley', date: '2026-02-15', status: 'completed', weight: 96, bodyFat: 23.5, mood: 5, energy: 8, stress: 2, sleepHours: 7, adherence: 90, nutritionScore: 8, notes: 'Under 96kg for the first time! Cardio is getting easier too.', wins: 'Sub-96kg milestone!, 4/4 sessions, Ran 5K without stopping for the first time, Cooked every meal this week', challenges: 'Sunday dinner out was hard to track macros', coachFeedback: 'Massive milestone Tom! 9kg down is no joke. Let\'s target 93 by end of March.', reviewStatus: 'reviewed', flagReason: '' },
  { id: 'ci-16', clientId: 'c7', clientName: 'Tom Bradley', date: '2026-02-08', status: 'completed', weight: 96.5, bodyFat: 23.8, mood: 4, energy: 7, stress: 3, sleepHours: 7.5, adherence: 85, nutritionScore: 7, notes: 'Missed one cardio session but kept nutrition clean.', wins: '3/4 sessions completed, Nutrition was solid all week, Lost 0.5kg', challenges: 'Skipped Saturday cardio — was at a friend\'s birthday', coachFeedback: 'Nutrition consistency matters more than one missed cardio. You\'re doing great.', reviewStatus: 'reviewed', flagReason: '' },
  { id: 'ci-16b', clientId: 'c7', clientName: 'Tom Bradley', date: '2026-02-01', status: 'completed', weight: 97, bodyFat: 24, mood: 4, energy: 7, stress: 3, sleepHours: 7, adherence: 90, nutritionScore: 7, notes: 'Solid week. Starting to actually enjoy cardio which is wild.', wins: '4/4 sessions, First time enjoying a run, Weight still trending down', challenges: 'Craved pizza hard on Wednesday — had a small portion instead of none', coachFeedback: 'Having a small portion IS the win. That\'s sustainable. Keep doing that.', reviewStatus: 'reviewed', flagReason: '' },
  { id: 'ci-16c', clientId: 'c7', clientName: 'Tom Bradley', date: '2026-01-25', status: 'completed', weight: 97.5, bodyFat: 24.3, mood: 3, energy: 6, stress: 4, sleepHours: 6.5, adherence: 80, nutritionScore: 6, notes: 'Good but not great. Felt tired midweek.', wins: '3/4 sessions, Kept tracking even when off plan', challenges: 'Midweek fatigue, Ate out twice, Sleep was broken 2 nights', coachFeedback: 'Tracking when off-plan shows maturity. That data helps us adjust. Prioritize sleep this week.', reviewStatus: 'reviewed', flagReason: '' },

  // ── Aisha Patel — newer client, building habits ──
  { id: 'ci-17', clientId: 'c8', clientName: 'Aisha Patel', date: '2026-02-26', status: 'scheduled', weight: null, bodyFat: null, mood: null, energy: null, stress: null, sleepHours: null, adherence: null, nutritionScore: null, notes: '', wins: '', challenges: '', coachFeedback: '', reviewStatus: 'pending', flagReason: '' },
  { id: 'ci-18', clientId: 'c8', clientName: 'Aisha Patel', date: '2026-02-19', status: 'completed', weight: 57, bodyFat: 24.5, mood: 4, energy: 7, stress: 3, sleepHours: 7, adherence: 80, nutritionScore: 7, notes: 'Really enjoying the new glute focus! Posture feels better at work.', wins: 'Posture improvement at desk, Completed all 3 sessions, Tried hip thrusts for the first time', challenges: 'Still figuring out pre-workout nutrition', coachFeedback: 'That\'s the posture work paying off. Adding hip thrusts next week.', reviewStatus: 'reviewed', flagReason: '' },
  { id: 'ci-18b', clientId: 'c8', clientName: 'Aisha Patel', date: '2026-02-12', status: 'completed', weight: 57.5, bodyFat: 25, mood: 3, energy: 6, stress: 4, sleepHours: 6.5, adherence: 70, nutritionScore: 6, notes: 'Okay week. Work got busy and I missed Friday.', wins: '2/3 sessions, Started eating more protein', challenges: 'Missed Friday session, Didn\'t meal prep', coachFeedback: 'Protein increase is great! Try prepping just 3 meals for the busy days — doesn\'t need to be all week.', reviewStatus: 'reviewed', flagReason: '' },
  { id: 'ci-18c', clientId: 'c8', clientName: 'Aisha Patel', date: '2026-02-05', status: 'completed', weight: 57.5, bodyFat: 25, mood: 4, energy: 7, stress: 3, sleepHours: 7, adherence: 80, nutritionScore: 6, notes: 'Felt good this week. Getting into a routine.', wins: '3/3 sessions done!, Morning routine is becoming a habit', challenges: 'Nutrition still inconsistent on weekends', coachFeedback: 'Consistency breeds results. Great to see the routine forming!', reviewStatus: 'reviewed', flagReason: '' },

  // ── Emma Rodriguez — beginner, high enthusiasm ──
  { id: 'ci-19', clientId: 'c4', clientName: 'Emma Rodriguez', date: '2026-02-24', status: 'scheduled', weight: null, bodyFat: null, mood: null, energy: null, stress: null, sleepHours: null, adherence: null, nutritionScore: null, notes: '', wins: '', challenges: '', coachFeedback: '', reviewStatus: 'pending', flagReason: '' },
  { id: 'ci-20', clientId: 'c4', clientName: 'Emma Rodriguez', date: '2026-02-17', status: 'completed', weight: 74.5, bodyFat: 29.5, mood: 4, energy: 7, stress: 3, sleepHours: 7, adherence: 75, nutritionScore: 5, notes: 'Had my first workout and loved it! Still figuring out the gym routine.', wins: 'First week in the gym!, Tried squats for the first time, Signed up for MyFitnessPal', challenges: 'Felt intimidated at the gym, Not sure how to track macros yet, Missed Wednesday', coachFeedback: 'Amazing start Emma! Don\'t worry about perfection yet — consistency is key. We\'ll dial in nutrition next.', reviewStatus: 'reviewed', flagReason: '' },
];
