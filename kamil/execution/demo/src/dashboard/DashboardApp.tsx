...
export default function DashboardApp() {
  ...
  // DEMO GUARD: block adding new clients
  const handleSaveNewClient = (_client: Client) => {
    guardAction('Adding clients');
  };
  ...
  // DEMO GUARD: block deleting clients
  const handleDeleteClient = (_id: string) => {
    guardAction('Deleting clients');
  };
  ...
  // DEMO GUARD: block deleting programs
  const handleDeleteProgram = (_id: string) => {
    guardAction('Deleting programs');
  };
