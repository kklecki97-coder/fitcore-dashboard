...
export const pl: Translations = {
  ...
  progress: {
    ...
    current: 'Teraz',
    change: 'Zmiana',
    targetWeight: 'Cel Wagi',
    targetBodyFat: 'Cel Tkanki Tłuszczowej',
    targetBenchPress: 'Wyciskanie',
    targetSquat: 'Przysiad',
    targetDeadlift: 'Martwy Ciąg',
    shareProgress: 'Udostępnij swoje postępy',
    photoInvalidType: 'Dozwolone są tylko pliki JPEG, PNG, WebP i HEIC.',
    photoTooLarge: 'Zdjęcie musi mieć mniej niż 5 MB',
  },
